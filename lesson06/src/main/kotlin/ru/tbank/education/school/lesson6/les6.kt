...
// = run
// контекст: it
// возвращает: результат от вычислений в {}
// когда использовать: преобразование значения, работа с nullable (безопасно)
val r11 = "hello".let { it.uppercase() } // HELLO
val r12 = "hello".let { "Nope" } // Nope
...
// 3) apply
// фан-факт это тоже самое что и анонимные классы
// контекст: this
...
// with ( x ) { операции над x, больше нигде не доступны, только в рамках блока, возвращает элемент}
val r4 = with("hello") {
    this + " world"
}